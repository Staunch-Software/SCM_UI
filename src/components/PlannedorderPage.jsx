...
const PlannedOrdersPage = ({ setCurrentPage }) => {
  ...
  const formatDate = (dateString) => {
    ...
    // Creates a new Date object and formats it to a locale-specific date string (e.g., MM/DD/YYYY)
          ...
          <tbody>
            {filteredOrders.map((o, idx) => (
              ...
              >
                ...
                <td>{formatDate(o.confirmation_date)}</td>
                <td>{formatDate(o.suggested_due_date)}</td>
                <td>
