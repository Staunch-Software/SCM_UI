...
const getRelativeTime = (timestamp) => {
  ...
  // Force both to UTC for comparison
  const diffMs = now.getTime() - past.getTime();
  //  console.log('Difference in hours:', diffMs / 3600000);
              ...
              {group.sessions.map(session => (
                ...
                >
                  ...
                  <div className="session-content">
                    ...
                    <div className="session-preview">{getRelativeTime(session.lastActivity || session.createdAt)}</div>
                  </div>
